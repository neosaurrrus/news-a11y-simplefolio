...
export const aboutData = {
  ...
  paragraphTwo:
    'The issues found are around link names, iframe titles, and unique id attributes. However these issues are the exception than the norm, the 94 score being well earned once past the paywall.',
  paragraphThree:
    'Manual testing was broadly good however with one significant exception, handling the subscription prompt that appears on the main page was quite difficult, getting ignored by my screen reader and hard to keyboard focus on. This is particularly frustrating when the content behind the paywall otherwise has great accessibility.',
...
export const projectsData = [
  ...
  },
  {
    ...
    info:
      'Different colours are used consistently to show interactive elements with an additional underline and colour change provided on focus.  Author links are less clear but still provide good. The subscription prompt however, uses formatting that makes it less clear when interactive elements are focused.  ',
  },
  {
    id: nanoid(),
    ...
    info:
      'The site provides a splash screen to subscribe which, while focusable, is only focusable after focusing on the cookie prompt behind it (which cannot be read properly in this state). Its easy to get stuck behind the subscription prompt, focusing on the newspaper content, as the focus formatting is not very clear on the subscription element itself.',
  },
  {
    id: nanoid(),
    ...
    info2: 'Suggestions: None.',
    info:
      'In testing, the user focus is never trapped in a region. But its worth reiterating that the pop-ups provide ample opportunity to get lost while tab focussing.',
  },
  {
    id: nanoid(),
